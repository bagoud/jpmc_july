...
create streaming table sai_silver.sales_cleaned_pl
...
CREATE OR REFRESH STREAMING TABLE sai_silver.products_cleaned;

CREATE FLOW product_flow
AS AUTO CDC INTO
  sai_silver.products_cleaned
...
CREATE OR REFRESH STREAMING TABLE sai_silver.customers_cleaned;

CREATE FLOW customer_flow
AS AUTO CDC INTO
  sai_silver.customers_cleaned
